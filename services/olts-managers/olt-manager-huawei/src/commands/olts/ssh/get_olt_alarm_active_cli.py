...
class GetOltAlarmActiveCliCommand(OLTCommand):
    """Command to execute 'display alarm active all' via CLI."""

    def execute(self, connection_manager, olt_version: str) -> Dict[str, Any]:
        raw_output = connection_manager.send_command("display alarm active all")
