...
class GetOltTemperatureCliCommand(OLTCommand):
    """Command to execute 'display temperature' via CLI."""

    def execute(self, connection_manager, olt_version: str) -> Dict[str, Any]:
        raw_output = connection_manager.send_command("display temperature")
