...
class GetOntMacCountSnmpCommand(OLTCommand):
    """Get MAC address count learned by an ONT via SNMP (Huawei MA5800)."""

    OID_ONT_MAC_COUNT = "1.3.6.1.4.1.2011.6.128.1.1.2.46.1.21"
    ...
    def execute(self, connection_manager=None, olt_version: str = None) -> Dict[str, Any]:
        async def _execute_async() -> Dict[str, Any]:
            ...
            oid = f"{self.OID_ONT_MAC_COUNT}.{ont_index}"
