...
class SetLaserStateCommand(OLTCommand):
    """Command to execute 'laser' and parse its output."""

    def __init__(self, port: str, state: str):
        self.port = port
        self.state = state
    ...
    def execute(self, connection_manager, olt_version: str) -> Dict[str, Any]:
        ...
        command_sequence = [
            ...
            f"port {parts[2]} laser {self.state}",
            "quit",
            "quit"
        ]
        raw_output = ""
    ...
    def _parse_output(self, raw_output: str, olt_version: str) -> Dict[str, Any]:
        """Parses the output of the 'laser' command."""
