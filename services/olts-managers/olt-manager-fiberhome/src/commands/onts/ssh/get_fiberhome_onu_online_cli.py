...
class GetFiberhomeOnuOnlineCliCommand(OLTCommand):
    """Command to execute 'show onu online slot <s> link <l>' via CLI."""
    ...
    def execute(self, connection_manager, olt_version: str) -> Dict[str, Any]:
        command_str = f"show onu online slot {self.slot} link {self.link}"
