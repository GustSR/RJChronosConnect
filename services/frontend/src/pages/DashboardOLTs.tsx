...
const DashboardOLTs: FC = () => {
  ...
  const alarmesSeguranca = [
    { tipo: 'Login Suspeito', olt: 'OLT-Central-01', timestamp: '2024-01-15 14:30', severidade: 'alta' },
    { tipo: 'Tentativa de Acesso', olt: 'OLT-Bairro-05', timestamp: '2024-01-15 13:45', severidade: 'média' },
    { tipo: 'Configuração Alterada', olt: 'OLT-Norte-08', timestamp: '2024-01-15 12:20', severidade: 'baixa' }
  ];
    ...
    <Box sx={{ p: 3, backgroundColor: 'background.default', minHeight: '100vh' }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Monitoramento avançado das OLTs - Saúde, Performance, Segurança e Tráfego
        </Typography>
      </Box>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <Card sx={{ boxShadow: 2 }}>
            <CardContent sx={{ textAlign: 'center' }}>
              <SignalCellularAlt sx={{ fontSize: 40, color: 'primary.dark', mb: 1 }} />
              <Typography variant="h4" sx={{ fontWeight: 600 }}>
                    ...
                    {alarmesSeguranca.map((alarme, index) => (
                      <Box key={index}>
                        <ListItem sx={{ px: 0 }}>
                          <ListItemAvatar>
                            <Avatar sx={{ 
                              bgcolor: getSeveridadeColor(alarme.severidade) + '.main',
                              color: 'white'
                            }}>
                              <Security />
                            </Avatar>
                            ...
                            primary={
                              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                ...
                                <Chip 
                                  ...
                                  color={getSeveridadeColor(alarme.severidade) as any}
                                  size="small" 
                                />
                              </Box>
                            }
                          ...
                          <ListItemText
                            ...
                            secondary={
                              <Box sx={{ mt: 1 }}>
                                  ...
                                  <Grid item xs={6} sm={3}>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                      <ThermostatAuto 
                                        sx={{ 
                                          fontSize: 16, 
                                          color: getTemperaturaColor(olt.temperatura) + '.main'
                                        }} 
                                      />
                                  ...
                                  <Grid item xs={6} sm={3}>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                      <Memory 
                                        sx={{ 
                                          fontSize: 16, 
                                          color: getUsageColor(olt.cpuUsage) + '.main'
                                        }} 
                                      />
                                      <Typography variant="body2">
                                        CPU {olt.cpuUsage}%
                                  ...
                                  <Grid item xs={6} sm={3}>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                      <Storage 
                                        sx={{ 
                                          fontSize: 16, 
                                          color: getUsageColor(olt.memoryUsage) + '.main'
                                        }} 
                                      />
                                      <Typography variant="body2">
                                        RAM {olt.memoryUsage}%
                                  ...
                                  <Grid item xs={6} sm={3}>
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                      <Timeline 
                                        sx={{ 
                                          fontSize: 16, 
                                          color: getUsageColor(olt.trafego) + '.main'
                                        }} 
                                      />
                                      <Typography variant="body2">
                                        {olt.trafego}% tráfego
                                ...
                                {olt.alarmes > 0 && (
                                  <Chip 
                                    label={`${olt.alarmes} alarme${olt.alarmes > 1 ? 's' : ''} ativo${olt.alarmes > 1 ? 's' : ''}`}
                                    color="error" 
                                    size="small"
                                    sx={{ mt: 1 }}
                                  />
            ...
            <Grid item xs={12}>
              <Card sx={{ boxShadow: 2 }}>
                <CardContent>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      <Typography variant="body2">Atenção Necessária</Typography>
