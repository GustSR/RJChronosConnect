...
const AddOnuModal: React.FC<AddOnuModalProps> = ({
  ...
  const filteredONUs = pendingONUs.filter(
    (onu) =>
      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Selecione uma ONU/ONT para provisionar para{' '}
              ...
              <Grid item xs={12} key={onu.id}>
                <Card
                  sx={{
                    ...
                    borderColor:
                      selectedONU === onu.id ? 'primary.main' : 'divider',
                    cursor: 'pointer',
                    ...
                    <Grid container spacing={2} alignItems="center">
                      ...
                      <Grid item xs={12} md={4}>
                        <Stack spacing={1}>
                          ...
                          <Tooltip
                            title={`Board ${onu.board}, Port ${onu.port}`}
                          >
                            <Chip
