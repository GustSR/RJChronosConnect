import { Box, CardContent, Grid, Typography, Chip, LinearProgress, Alert, List, ListItem, ListItemText, ListItemAvatar, Avatar, Divider } from '@mui/material';
import { AnimatedCard, KpiCard } from '@shared/ui/components';
import { FC } from 'react';
import { ThermostatAuto, SignalWifi4Bar, SignalWifiStatusbar4Bar, SignalWifiStatusbarNull, Devices, Warning, CheckCircle, Speed, Person } from '@mui/icons-material';

const DashboardClientesPage: FC = () => {
    ...
    >
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={2}>
          <KpiCard
            delay={100}
            icon={<Person sx={{ fontSize: 40, color: 'primary.main', mb: 1 }} />}
            value={estatisticasClientes.totalClientes}
        ...
        <Grid item xs={12} sm={6} md={2}>
          <KpiCard
            delay={200}
            icon={<CheckCircle sx={{ fontSize: 40, color: 'success.main', mb: 1 }} />}
            value={estatisticasClientes.clientesOnline}
        ...
        <Grid item xs={12} sm={6} md={2}>
          <KpiCard
            delay={300}
            icon={<Warning sx={{ fontSize: 40, color: 'warning.main', mb: 1 }} />}
            value={estatisticasClientes.clientesComProblemas}
            label="Com Problemas"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <KpiCard
            delay={400}
            icon={<ThermostatAuto sx={{ fontSize: 40, color: 'info.main', mb: 1 }} />}
            value={`${estatisticasClientes.temperaturaMedia}°C`}
            label="Temp. Média"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <KpiCard
            delay={500}
            icon={<Speed sx={{ fontSize: 40, color: 'secondary.main', mb: 1 }} />}
            value={`${estatisticasClientes.sinalMedio}dBm`}
            label="Sinal Médio"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={2}>
          <KpiCard
            delay={600}
            icon={<Devices sx={{ fontSize: 40, color: 'primary.dark', mb: 1 }} />}
            value={estatisticasClientes.dispositivosMedio}
            label="Dispositivos Médio"
          />
        </Grid>
      </Grid>
