import { Box, CardContent, Grid, Typography, Chip, LinearProgress, List, ListItem, ListItemText, ListItemAvatar, Avatar, Divider, IconButton, Tooltip, Alert } from '@mui/material';
import { AnimatedCard, KpiCard } from '@shared/ui/components';
import { FC } from 'react';
import { Router, ThermostatAuto, Memory, Security, Warning, CheckCircle, SignalCellularAlt, Visibility, Storage, Timeline } from '@mui/icons-material';

const DashboardOLTsPage: FC = () => {
    ...
    >
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <KpiCard
            delay={100}
            icon={<Router sx={{ fontSize: 40, color: 'primary.main', mb: 1 }} />}
            value={estatisticasOLTs.totalOLTs}
            label="Total OLTs"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <KpiCard
            ...
            value={estatisticasOLTs.oltsOnline}
            label="Online"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <KpiCard
            ...
            value={estatisticasOLTs.oltsComProblemas}
            label="Com Problemas"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <KpiCard
            ...
            value={`${estatisticasOLTs.temperaturaMedia}°C`}
            label="Temp. Média"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <KpiCard
            delay={500}
            icon={<Memory sx={{ fontSize: 40, color: 'secondary.main', mb: 1 }} />}
            value={`${estatisticasOLTs.cpuMedio}%`}
            label="CPU Médio"
          />
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={3} lg={2}>
          <KpiCard
            delay={600}
            icon={<SignalCellularAlt sx={{ fontSize: 40, color: 'primary.dark', mb: 1 }} />}
            value={`${estatisticasOLTs.trafegoTotal}%`}
            label="Tráfego Total"
          />
        </Grid>
      </Grid>
...
export default DashboardOLTsPage;
