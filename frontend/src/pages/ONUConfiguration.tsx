              ...
              <Stack spacing={2}>
                ...
                <Box>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    <Chip 
                      label={onuDetails.signalStrength >= -20 ? 'Ótimo' : onuDetails.signalStrength >= -25 ? 'Bom' : 'Fraco'}
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    <FormControl fullWidth size="small">
                      ...
                      <Select
                        ...
                        sx={{ borderRadius: 2 }}
                      >
                        <MenuItem value="residential_100mb">Residencial 100MB</MenuItem>
                        <MenuItem value="residential_200mb">Residencial 200MB</MenuItem>
                        <MenuItem value="business_500mb">Empresarial 500MB</MenuItem>
                        <MenuItem value="business_1gb">Empresarial 1GB</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
                  <Grid item xs={12}>
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      label="VLAN"
                      value={config.vlan}
                      onChange={(e) => setConfig(prev => ({ ...prev, vlan: e.target.value }))}
                      size="small"
                      type="number"
                      sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                    />
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={4}>
                    <FormControl fullWidth size="small">
                      ...
                      <Select
                        value={config.ipMode}
                        label="Modo IP"
                        onChange={(e) => setConfig(prev => ({ ...prev, ipMode: e.target.value as any }))}
                        sx={{ borderRadius: 2 }}
                      >
                    ...
                    <>
                      <Grid item xs={12} md={4}>
                        <TextField
                          ...
                          onChange={(e) => setConfig(prev => ({ ...prev, pppoeUser: e.target.value }))}
                          size="small"
                          sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                        />
                      </Grid>
                      <Grid item xs={12} md={4}>
                        <TextField
                          ...
                          onChange={(e) => setConfig(prev => ({ ...prev, pppoePassword: e.target.value }))}
                          size="small"
                          sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                        />
                      </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      label="DNS Primário"
                      value={config.dns1}
                      onChange={(e) => setConfig(prev => ({ ...prev, dns1: e.target.value }))}
                      size="small"
                      sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                    />
                  </Grid>
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      value={config.dns2}
                      onChange={(e) => setConfig(prev => ({ ...prev, dns2: e.target.value }))}
                      size="small"
                      sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                    />
                  </Grid>
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        ...
                        onChange={(e) => setConfig(prev => ({ ...prev, wifiEnabled: e.target.checked }))}
                        color="primary"
                      />
                    }
                    label="Wi-Fi Ativo"
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12}>
                      <Alert severity="info" sx={{ mb: 2 }}>
                        Configure as redes Wi-Fi 2.4GHz e 5GHz separadamente para melhor performance.
                      </Alert>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        label="SSID 2.4GHz"
                        value={config.ssid2g}
                        onChange={(e) => setConfig(prev => ({ ...prev, ssid2g: e.target.value }))}
                        size="small"
                        sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                      />
                    </Grid>
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        onChange={(e) => setConfig(prev => ({ ...prev, password2g: e.target.value }))}
                        size="small"
                        sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                      />
                    </Grid>
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        label="SSID 5GHz"
                        value={config.ssid5g}
                        onChange={(e) => setConfig(prev => ({ ...prev, ssid5g: e.target.value }))}
                        size="small"
                        sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                      />
                    </Grid>
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        onChange={(e) => setConfig(prev => ({ ...prev, password5g: e.target.value }))}
                        size="small"
                        sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                      />
                    </Grid>
                    ...
                    <Grid item xs={12} md={4}>
                      <FormControl fullWidth size="small">
                        ...
                        <Select
                          ...
                          label="Canal 2.4GHz"
                          onChange={(e) => setConfig(prev => ({ ...prev, wifiChannel2g: e.target.value }))}
                          sx={{ borderRadius: 2 }}
                        >
                    ...
                    <Grid item xs={12} md={4}>
                      <FormControl fullWidth size="small">
                        ...
                        <Select
                          ...
                          label="Canal 5GHz"
                          onChange={(e) => setConfig(prev => ({ ...prev, wifiChannel5g: e.target.value }))}
                          sx={{ borderRadius: 2 }}
                        >
                          <MenuItem value="auto">Automático</MenuItem>
                    ...
                    <Grid item xs={12} md={4}>
                      <FormControl fullWidth size="small">
                        ...
                        <Select
                          ...
                          label="Segurança"
                          onChange={(e) => setConfig(prev => ({ ...prev, wifiSecurity: e.target.value }))}
                          sx={{ borderRadius: 2 }}
                        >
                ...
                <Grid container spacing={3}>
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => setConfig(prev => ({ ...prev, bridgeMode: e.target.checked }))}
                          color="primary"
                        />
                      }
                      label="Modo Bridge"
                    ...
                    <FormControlLabel
                      control={
                        <Switch
                          ...
                          onChange={(e) => setConfig(prev => ({ ...prev, qosEnabled: e.target.checked }))}
                          color="primary"
                        />
                      }
                      label="QoS Ativo"
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      onChange={(e) => setConfig(prev => ({ ...prev, managementVlan: e.target.value }))}
                      size="small"
                      type="number"
                      sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                    />
